...
var Badge = function (_a) {
    ...
    return (React__default["default"].createElement("div", { style: badgeStyle, className: styles$7.badge },
...
var Button = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: styles$6[variant], onClick: onClick },
...
var SummonerIcon = React__default["default"].forwardRef(function (_a, ref) {
    ...
    return (React__default["default"].createElement("div", __assign$1({}, props, { ref: ref, className: styles$5.profileIcon, style: { width: size, height: size }, "data-selected": selected, "data-favorite": favorite }),
        React__default["default"].createElement("img", { loading: 'lazy', src: "https://raw.communitydragon.org/latest/game/assets/ux/summonericons/profileicon".concat(iconId, ".png") }),
        availability !== undefined && (React__default["default"].createElement("div", { className: "".concat(styles$5.availability), "data-availability": availability }))));
});
...
var Profile = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: styles$4.profile },
        React__default["default"].createElement(SummonerIcon, { iconId: iconId, availability: availability }),
        React__default["default"].createElement("div", { className: styles$4.content },
            React__default["default"].createElement("div", { className: styles$4.header },
                React__default["default"].createElement("span", { className: styles$4.name }, name),
                React__default["default"].createElement("span", { className: styles$4.riotId },
                    "#",
                    riotId)),
            React__default["default"].createElement("div", { className: styles$4.badges },
...
var Checkbox = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: styles$3.checkbox },
        React__default["default"].createElement("span", { className: styles$3.title }, title),
...
var Dropdown = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: styles$2.dropdown, "data-extended": extended },
        React__default["default"].createElement("div", { className: styles$2.head, onClick: function () { return setExtended(!extended); } },
            ...
            icon),
        React__default["default"].createElement("div", { className: styles$2.items }, items.map(function (title) { return (React__default["default"].createElement("div", { className: styles$2.item, "data-selected": selected === title, onClick: function () { return handleChange(title); } }, title)); }))));
};
...
var Textbox = React__default["default"].forwardRef(function (props, ref) {
    return React__default["default"].createElement("input", __assign$1({}, props, { ref: ref, className: styles$1.textbox }));
});
...
var Splashart = React__default["default"].forwardRef(function (_a, ref) {
    ...
    return (React__default["default"].createElement("div", __assign$1({}, props, { ref: ref, className: styles.splashart, "data-selected": selected, "data-favorite": favorite }),
        React__default["default"].createElement("img", { loading: 'lazy', src: "https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/champion-splashes/".concat(championId, "/").concat(skinId, ".jpg") })));
});
