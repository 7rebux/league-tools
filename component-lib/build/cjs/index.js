...
function Button(_a) {
    ...
    return (React__default["default"].createElement("div", { className: styles.button, style: buttonStyle },
        React__default["default"].createElement("span", { style: textStyle }, title)));
}
