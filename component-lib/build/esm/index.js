...
var ProfileIcon = function (_a) {
    ...
    return (React.createElement("div", { className: styles$4.profileIcon, style: { width: size, height: size }, "data-selected": selected, "data-favorite": favorite },
        ...
        availability !== undefined && (React.createElement("div", { className: "".concat(styles$4.availability), "data-availability": availability }))));
};
...
var Checkbox = function (_a) {
    ...
    return (React.createElement("div", { className: styles$2.checkbox },
...
var Dropdown = function (_a) {
    ...
    var _d = useState(false), extended = _d[0], setExtended = _d[1];
    var _e = useState(initialItem), selected = _e[0], setSelected = _e[1];
    ...
    return (React.createElement("div", { className: styles$1.dropdown },
        React.createElement("div", { className: styles$1.head, "data-custom": extended, onClick: function () { return setExtended(!extended); } },
            React.createElement("span", { className: styles$1.title }, selected),
            icon),
        extended && (React.createElement("div", { className: styles$1.items },
            searchBar && React.createElement(SearchBar, { onInput: function (value) { return setFilter(value); } }),
            filtered.map(function (title) { return (React.createElement("div", { className: styles$1.item, "data-custom": selected === title, onClick: function () { return handleChange(title); } }, title)); })))));
};
...
var SearchBar = function (_a) {
    ...
    return (React.createElement("input", { className: styles.searchBar, value: input, onInput: function (e) { return handleInput(e); }, placeholder: placeholder }));
};

export { Badge, Button, Checkbox, Dropdown, Profile, SearchBar, ProfileIcon as SummonerIcon };
